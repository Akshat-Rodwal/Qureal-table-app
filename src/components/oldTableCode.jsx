...
//   // Resizing table functionality
//   const [size, setSize] = useState(() => {
//     const savedSize = localStorage.getItem("tableSize");
//     return savedSize ? JSON.parse(savedSize) : { width: 500, height: 300 };
//   });
...
//     const newWidth = Math.max(100, width + (e.clientX - x));
//     const newHeight = Math.max(50, height + (e.clientY - y));
...
//     // Save the table size to localStorage
...
//         {/* Conditionally render resizer handle */}
